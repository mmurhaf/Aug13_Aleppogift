...
function sendInvoiceEmail($to, $orderId, $attachmentPath) {
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = "Your AleppoGift Order Confirmation (Order #$orderId)";
        ...
        $mail->AltBody = "Your order #$orderId has been placed. A PDF invoice is attached.";
        $mail->send();
    } catch (Exception $e) {
